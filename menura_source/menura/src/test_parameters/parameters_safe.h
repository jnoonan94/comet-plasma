...
const int len_x_cst        = 512 ;
const int len_y_cst        = 512 ;
const int nb_part_node_cst = 300 ; //16384 ;
...
const int  pool_size_cst = int(1.*nb_part_node_cst*len_x_cst*len_y_cst) ;
...
const bool decay_turb_cst    = true ;
...
struct simu_param {
  ...
  float n0_no_norm  = 1.5e6 ;
  float B0_no_norm  = 1.1e-9 ;
  float v0          = 0. ;
  ...
  //
  float poly_ind     = 1. ; //1. ;
  float eta_res_norm = 2.e-3 ; //.00375 ; //eta_res*q*n0_no_norm/B0_no_norm ;
  float eta_sm       = 0. ;
  //
  float fluctu_sqrt_B = 0.4 ;
  float fluctu_sqrt_v = 0.4 ;
  ...
  void output_parameters(){
    if (mpi_rank==0){
      ...
      thefile << "nu_d                " << nu_d                 << "\n" ;
      thefile << "u0                  " << u0                   << "\n" ;
      thefile << "fluctu_sqrt_B       " << fluctu_sqrt_B        << "\n" ;
      thefile << "fluctu_sqrt_v       " << fluctu_sqrt_v        << "\n" ;
      thefile << "d_i                 " << d_i                  << "\n" ;
